/*
https://github.com/swistaczek/Code-lock/blob/master/rs232.c
***************************************************************************
*
...
int RS232_SendByte(int comport_number, unsigned char byte) {
	return write(Cport[comport_number], &byte, 1);
...
char *comports[RS232_PORTNR] = { 
	...
	"\\\\.\\COM61", "\\\\.\\COM62", "\\\\.\\COM63", "\\\\.\\COM64", "\\\\.\\COM75",
	"\\\\.\\COM66", "\\\\.\\COM67", "\\\\.\\COM68", "\\\\.\\COM69", "\\\\.\\COM80",
};
...
int RS232_OpenComport(int comport_number, int baudrate, const char *mode)
{
	...
	*/
	Cptimeouts.ReadIntervalTimeout = 2;
...
void RS232_CloseComport(int comport_number)
{
	...
	GetHandleInformation(Cport[comport_number], (LPDWORD)((void *)&n));
	if (n == 0) { 
		CloseHandle(Cport[comport_number]); 
	}
}
